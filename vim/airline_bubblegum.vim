...
let g:airline#themes#bubblegum#palette.replace = {
      ...
      \ 'airline_c': [s:gui_red, s:gui_med_gray_hi, s:cterm_bright_red, s:cterm_med_gray_hi, ''],
      \ }
let g:airline#themes#bubblegum#palette.replace_modified = copy(g:airline#themes#bubblegum#palette.insert_modified)

" Visual mode
let s:V1 = [s:gui_dark_gray, s:gui_blue, s:cterm_white, s:cterm_blue]
...
" Inactive window
let s:IA = [s:gui_light_gray, s:transparent, s:cterm_light_gray, s:transparent, '']
