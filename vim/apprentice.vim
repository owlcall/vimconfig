...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  ...
  hi Comment          ctermbg=NONE ctermfg=28   guibg=NONE    guifg=#585858 cterm=NONE           gui=NONE
  hi Conceal          ctermbg=NONE ctermfg=250  guibg=NONE    guifg=#bcbcbc cterm=NONE           gui=NONE
  hi Constant         ctermbg=NONE ctermfg=167  guibg=NONE    guifg=#ff8700 cterm=NONE           gui=NONE
  ...
  hi Type             ctermbg=NONE ctermfg=163  guibg=NONE    guifg=#8787af cterm=NONE           gui=NONE
  ...
  hi Function         ctermbg=NONE ctermfg=110  guibg=NONE    guifg=#ffffaf cterm=NONE           gui=NONE
